    ...
    while True:
        ...
        if cmd == "help":
            ...
            if validation_result:
                ...
                exec_status, exec_message = client.change_stock(seller=AUTH_SELLER, product_id=arg_product_id,
                                                                change_amount=arg_change)
            ...
            if validation_result:
                ...
                exec_status, exec_message = client.change_cart(customer_id=arg_customer_id, product_id=arg_product_id,
                                                               seller_id=arg_seller_id, change_amount=arg_change)
